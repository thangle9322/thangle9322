...
public class Clan {
    ...
    public Clan() {
        ...
        this.clanRank = new ClanRankData(this);
    }
    ...
    public void insert() {
        ...
        try (Connection con = DatabaseManager.getConnection();) {
            ps = con.prepareStatement("insert into clan (id, name, name_2, slogan, img_id, power_point, max_member, clan_point, level, members ) "
                    + "values (?,?,?,?,?,?,?,?,?,?)");
            ps.setInt(1, this.id);
    ...
    public void update() {
        ...
        try (Connection con = DatabaseManager.getConnection();) {
            ps = con.prepareStatement("update clan set slogan = ?, img_id = ?, power_point = ?, max_member = ?, clan_point = ?, "
                    + "level = ?, members = ?, name_2 = ? where id = ? limit 1");
