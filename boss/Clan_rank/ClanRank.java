...
public abstract class ClanRank extends Boss {
    ...
    public ClanRank(BossType bosstype, int id, BossData data) throws Exception {
    ...
    public void leaveMap() {
        if (playerAtt.location != null && playerAtt != null && playerAtt.zone != null && this.zone != null && this.zone.equals(playerAtt.zone) && !playerAtt.lostByDeath) {
            Service.gI().chat(this, ConstClanRank.TEXT_CLONE_THUA);
        } else {
            Service.gI().chat(this, ConstClanRank.TEXT_CLONE_THANG);
        }
