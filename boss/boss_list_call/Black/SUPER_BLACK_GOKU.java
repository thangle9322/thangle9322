package boss.boss_list_call.Black;
...
public class SUPER_BLACK_GOKU  extends Boss_call{

    private long st;
    private int timeLeaveMap;

    public SUPER_BLACK_GOKU (Player player) throws Exception {
        super(BossID.BLACK_GOKU, false, true,  BossesData.SUPER_BLACK_GOKU);
...
public void joinMap() {
    ...
    super.joinMap();
    Zone zone = playerAtt.zone;
    if (zone == null) {
        Service.gI().sendThongBao(playerAtt, "Không thể thực thi lệnh");
        this.changeStatus(BossStatus.RESPAWN);
        return;
    }
    // Lúc này mới gán zone
    this.zone = zone;
    // Di chuyển tới vị trí người gọi
