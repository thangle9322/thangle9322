...
public class Template {
    ...
    public static class WaitClanRank {
        public long playerclanId;
        public long rivalclanId; 

        public WaitClanRank(long playerclanId, long rivalclanId) {
           this.playerclanId = playerclanId;
           this.rivalclanId = rivalclanId;
        }
    }
