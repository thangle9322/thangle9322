...
public class EffectSkillService {
    ...
    public static final byte PHANTAM_EFFECT = 43;
    ...
    public void setHoacarot(Player player, long lastTimeCarot, int timeCarot) {
    player.effectSkill.lastTimeCarot = lastTimeCarot;
    player.effectSkill.timeCarot = timeCarot;
    ...
    public void setPhanTam(Player player, int time) {
    player.effectSkill.isPhanTam = true;
    player.effectSkill.timePhanTam = time;
    player.effectSkill.lastTimePhanTam = System.currentTimeMillis();
