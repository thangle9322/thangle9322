    ...
    private boolean doneTask(Player player, int idTaskCustom) {
        if (TaskService.gI().isCurrentTask(player, idTaskCustom)) {
            ...
            switch (idTaskCustom) {
                ...
                Service.gI().sendThongBao(player, "Nào, bây giờ bạn có thể gặp ông %2 để báo cáo rồi!");           
                    break;
                case ConstTask.TASK_0_5:
                    npcSay(player, ConstTask.NPC_NHA,
                            ...
                            + "Bây giờ, con hãy ra %1 để tập luyện, hãy đánh ngã 5 mộc nhân, rồi trở về gặp ta, ta sẽ dạy con bay\n"
                ...
                case ConstTask.TASK_7_3:
                     npcSay(player, ConstTask.NPC_NHA, "Tốt lắm, con làm ta bất ngờ đấy. Bây giờ hãy đi lấy lại ngọc đem về đây cho ta");
                     break;
                ...
                case ConstTask.TASK_8_1:
                 ...
                 Service.gI().sendThongBao(player, "Tìm thấy viên ngọc rồng 7 sao rồi, đem về cho %2 nào!");
